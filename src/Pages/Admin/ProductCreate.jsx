...
const ProductCreate = () => {
  const [categories, setCategories] = useState([
    { name: "Electronics", subcategories: ["Mobile", "Laptop", "Camera"] },
    { name: "Fashion", subcategories: ["Men's Wear", "Women's Wear", "Kids"] },
  ]);
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6">
      ...
      {/* Subcategory Name */}
      <div className="mb-4">
        <label className="block text-gray-700 font-bold mb-2">Subcategory Name</label>
        <select
